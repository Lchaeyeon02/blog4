...
`,a9=Pe.div`
    ...
    margin-top: 117px;
    margin-bottom: 45px;
`;function o9(n){const e=lm(),[t,r]=Y.useState(""),[a,o]=Y.useState(""),[u,d]=Y.useState(""),p=()=>{let y=new Date().getTime().toString();ko.collection("post").doc(y).set({id:y,title:t,content:a,comments:[],date:y,category:u}).then(()=>{alert("글이 등록되었습니다!"),e("/")})},m=y=>{d(y)};return ie.jsxs(i9,{children:[ie.jsx(ST,{}),ie.jsxs(a9,{children:[ie.jsxs("a",{href:"",children:[" ",ie.jsx("img",{width:"48px",height:"48px",src:"../public/back.png",alt:"",onClick:()=>{e("/main")}})," "]}),ie.jsx(gm,{title:"Upload",type:"upload",onClick:y=>{p()}})]}),ie.jsxs(s9,{children:[ie.jsxs(xy,{children:[ie.jsx("label",{className:"labelCss",htmlFor:"",children:"category"}),ie.jsx(r9,{onChange:m})]}),ie.jsxs(xy,{children:[ie.jsx("label",{className:"labelCss",htmlFor:"",children:"title"}),ie.jsx(Fy,{height:"75",value:t,onChange:y=>r(y.target.value)})]}),ie.jsxs(xy,{children:[ie.jsx("label",{className:"labelCss",htmlFor:"",children:"content"}),ie.jsx(Fy,{height:"450",value:a,onChange:y=>o(y.target.value)})]})]})]})}const l9=Pe.div`
    display: grid;
    gap: 16px;
    margin-bottom: 32px;
`,fS=Pe.p`
